...
Original file is located at
    https://colab.research.google.com/drive/1lpTX_wcDxBbhiOKwHO0gs_lgRVyOKrWS
"""
...
# todo: добавить динамическое изменение лимита.
# todo: если пост не содержит контента, то +1 к лимиту постов
for channel in channels:
    ...
    for message in messages:
        ...
        # c 15 февраля
        compareDate = datetime(2026, 2, 15, 17, 0, tzinfo=timezone.utc)
